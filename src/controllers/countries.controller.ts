...
export class CountriesController {
  ...
  @Get('/')
  @OpenAPI({ summary: 'Get countries list' })
  async findAll(
  ...
  @Get('/:id')
  @OpenAPI({ summary: 'Get countries by id' })
  ...
  @Post('/bulk_create')
  @OpenAPI({ summary: 'Create countries' })
  async bulkCreate(@Body({ required: true }) body: Countries[], @Res() res: any) {
  ...
  @Delete('/:id')
  @OpenAPI({ summary: 'Delete countries' })
