...
@Service()
@Controller('/evaluation_option_values')
export class EvaluationOptionValuesController {
  constructor(public service: EvaluationOptionValuesService) {}

  @Get('/')
  @OpenAPI({ summary: 'Get evaluation_option_values list' })
  async findAll(
